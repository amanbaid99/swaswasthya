    ...
    <div className="container">
      <div className="story-grid" style={{
        ...
        <div style={{
          ...
          <img src="/images/Practice%20now.JPG" alt="Practice today" style={{ width: '100%', height: 280, objectFit: 'cover', objectPosition: 'center top', borderRadius: 'var(--radius-md)', display: 'block', marginTop: 40 }} />
